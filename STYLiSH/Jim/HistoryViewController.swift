...
//      var counter = 0
//      for count in 0 ..< storeManJim.historyData[0].orderlist.count{
//        //            for count2 in 0 ..< storeManJim.historyData[0].orderlist[count].list.count{
//        counter += storeManJim.historyData[0].orderlist[count].list.count
//        //            }
//      }
//      return counter
